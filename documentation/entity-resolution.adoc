...
We are using the Sorensen Dice Similarity algorithm from the Neo4j APOC library.

References

* https://neo4j.com/labs/apoc/4.1/overview/apoc.text/apoc.text.sorensenDiceSimilarity[apoc.text.sorensenDiceSimilarity^]
